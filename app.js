(() => {
  ...
  const I18N = {
    ...
    de: {
      ...
      setupHint: "Fuege Spieler hinzu und starte dann. Die Reihenfolge bestimmt die Zug-Markierung.",
      setupPlayerPlaceholder: "Spielername",
      setupAddPlayer: "Hinzufuegen",
      setupRecentPlayers: "Letzte Spieler",
      setupSeeHistory: "Spielverlauf",
      setupPlayerStatistics: "Spielerstatistik",
      ...
      gameHistory: "Verlauf",
      gameRoundDone: "Runde abschliessen",
      ...
      archiveTitle: "Spielarchiv",
      archiveClose: "Schliessen",
      archiveViewsAriaLabel: "Archivansichten",
      archiveTabGames: "Spiele",
      archiveTabStats: "Spielerstatistik",
      archiveNoGames: "Noch keine gespeicherten Spiele.",
      archiveSummaryLine: "{games} Spiele | {players} Spieler",
      archivePlayedAt: "Gespielt",
      archiveRounds: "Runden",
      archivePlayers: "Spieler",
      archiveWinners: "Sieger",
      archiveTopScore: "Top-Punkte",
      archiveRoundHeader: "Runde",
      statsPlayerLabel: "Spieler fuer Details",
      statsNoData: "Noch keine Archivdaten.",
      statsHeaderPlayer: "Spieler",
      statsHeaderGames: "Spiele",
      statsHeaderWon: "Gewonnen",
      statsHeaderLost: "Verloren",
      statsHeaderWinRate: "Sieg %",
      statsHeaderMax: "Max",
      statsHeaderAvg: "Durchschn.",
      statsHeaderMin: "Min",
      statsHeaderTotal: "Gesamt",
      statsHeaderAvgRank: "Durchschn. Rang",
      statsChartWinLoss: "Siege vs Niederlagen",
      statsChartPoints: "Min / Durchschnitt / Max Punkte",
      statsChartTrend: "Punktetrend",
      statsChartPositions: "Platzierungen",
      statsAxisGames: "Spiele",
      statsAxisPoints: "Punkte",
      statsAxisRank: "Rang",
      statsPositionPrefix: "Platz",
      ...
      graphXAxis: "Runde",
      graphYAxis: "Punkte",
      alertAddPlayer: "Mindestens einen Spieler hinzufuegen.",
      confirmNewGame: "Neues Spiel starten? Aktuelle Spieler und Rundendaten werden zurueckgesetzt.",
